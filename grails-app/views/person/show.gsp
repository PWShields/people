			...
			<ol class="property-list person">
				...
				<li class="fieldcontain">
					<span id="personName-label" class="property-label"><g:message code="person.personName.label" default="Person Name" /></span>
						...
						<span class="property-value" aria-labelledby="personName-label"><g:link controller="personName" action="show" id="${personInstance?.personName?.id}">${personInstance?.personName?.encodeAsHTML()}</g:link></span>
